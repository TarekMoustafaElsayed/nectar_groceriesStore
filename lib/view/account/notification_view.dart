...
import 'package:nectar_groceries/common/common_widget/notification_row.dart';
import 'package:nectar_groceries/model/address_model.dart';
import 'package:nectar_groceries/view_model/notification_view_model.dart';
    ...
    return Scaffold(
      ...
      body: Obx(
            ...
            itemBuilder: (context, index) {
              ...
              return NotificationRow(nObj: nObj, onTap: (){
