...
class AddressViewModel extends GetxController {
  ...
  void servicecCallList() {
    ...
    Globs.showHUD();
    ServiceCall.post({}, SVKey.svDeliveryAddress, isToken: true, withSuccess: (resObj) async {
      Globs.hideHUD();
  ...
  void serviceCallUpdate(int addressId, VoidCallback didDone) {
    ...
    }, SVKey.svUpdateDeliveryAddress, isToken: true, withSuccess: (resObj) async {
      Globs.hideHUD();
  ...
  void serviceCallRemove(AddressModel aObj) {
    ...
    ServiceCall.post({"address_id": (aObj.addressId ?? 0).toString()},
        SVKey.svDeleteDeliveryAddress, isToken: true, withSuccess: (resObj) async {
      Globs.hideHUD();
