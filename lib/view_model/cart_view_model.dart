...
import 'package:nectar_groceries/view/my_cart/order_accept_view.dart';
...
class CartViewModel extends GetxController {
  ...
  void serviceCallList() {
    ...
    Globs.showHUD();
    ServiceCall.post({"promo_code_id": promoObj.value.promoCodeId?.toString() ?? "","deliver_type": deliveryType.value}, SVKey.svCartList, isToken: true, withSuccess: (resObj) async {
      Globs.hideHUD();
      ...
      if ( resObj[KKey.status] == "1" ){
        ...
        deliverPriceAmount.value = resObj["deliver_price_amount"] as String? ?? "0.0";
